...
{{-- Resume Headline--}}
<div class="emply-resume-list row mb-1" id="headline1" style="display:inline-block; width:100%; background-color:rgba(99, 57, 116, 0.1);">
    <div class="row emply-info">
        <div class="col-md-12">
            <label style="width:100%;"><h5>Experience Summary:</h5></label>
            <textarea id="ta1" name="headline" style="height:120px; width:100%; resize:none; background-color:rgba(99, 57, 116, 0.01); border:0px" readonly></textarea>
        </div>
    </div>
</div>
...
{{-- Key Skills --}}
<div class="emply-resume-list row mb-1" id="keyskills1" style="display:inline-block; width:100%; background-color:rgba(99, 57, 116, 0.1);">
    <div class="row emply-info">
        <div class="col-md-12">
...
{{-- Address Details --}}
<div class="emply-resume-list row mb-1" id="add1" style="display:inline-block; width:100%; background-color:rgba(99, 57, 116, 0.1);">
    <div class="row emply-info">
        <div class="col-md-12">
