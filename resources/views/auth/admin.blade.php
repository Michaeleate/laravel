...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card" id="id_admlog" style="display:block;">
            ...
            <div class="card" id="id_admreg" style="display:none;">
                <div class="card-header">{{ __('Admin Register') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('aregister') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="user_type" name="user_type" value="Admin" readonly>
                                {{--
...
function showLogin(obj){
    document.getElementById("id_admlog").style.display = "block";
    document.getElementById("id_admreg").style.display = "none";
}

function showRegister(obj){
    document.getElementById("id_admlog").style.display = "none";
    document.getElementById("id_admreg").style.display = "block";
}
</script>
@endsection
