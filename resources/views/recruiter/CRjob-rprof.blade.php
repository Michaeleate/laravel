...
<div class="emply-resume-list row mb-1" id="i-initial" style="display:inline-block; width:100%">
    <div class="col-md-12 emply-info">
        <div class="emply-resume-info-sams">
            <form role="form" action="{{ url('/recruiter/jobposting')}}" method="post">
                @csrf
                ...
                <tr><td style="width:230px; text-align:right;"><label>Company you are hiring for:
                    ...
                    <td><input type="text" class="form-control" placeholder="Ex: IBM Pvt Ltd" name="hirecomp" id="i-hirecomp" style="width:420px; height:30px;"></td></tr>
                <tr><td style="width:230px; text-align:right;"><label>Job Title/ Designation:</label></td>
                    <td><input type="text" class="form-control" placeholder="Ex:- Software Engineer, not Software Eng" name="jtitle" id="i-jtitle" style="width:420px; height:30px;"></td></tr>
                ...
                <tr><td style="width:230px; vertical-align:top; text-align:right;"><label>Job Description:</label></td>
                    <td><textarea class="form-control" placeholder="Detailed Job Description. Max 750 characters" maxlength="750" name="jobdesc" id="i-jobdesc" rows="10" style="width:420px; resize: none;" onkeyup="countChars(this,'desc-char',750);"></textarea></td></tr>
                <tr><td style="width:230px;"><label></label></td>
                ...
                <tr><td style="width:230px; text-align:right;"><label>Keywords:
                    ...
                    <td><input type="text" class="form-control" placeholder="Ex:- telecaller, receptionist" name="jkey" id="i-jkey" style="width:420px; height:30px;"></td></tr>
                <tr><td style="width:230px;"><label></label></td>
                ...
                <tr><td style="width:230px; text-align:right;"><label>Work Experience:</label></td>
                    ...
                    <select class="form-control" id="i-minexp" name="minexp" placeholder="Minimum" style="display:inline-block; width:150px;">
                    ...
                    <div  style="display:inline-block;">
                    <select class="form-control" id="i-maxexp" name="maxexp" placeholder="Maximum" style="width:150px;">
